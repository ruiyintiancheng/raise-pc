...
<template>
  <div class="tt-plan">
    <div>
      <div class="tt-title txt-white">首要目标</div>
        <firstTable refs='first' :viewDate="getViewDate" label="目标" :startWeek="startWeek" 
            :endWeek="endWeek" :courseId="courseId" :disable="disable"></firstTable>
...
import matterTable from '@/views/targetTool/components/week/components/matterTable'
export default {
  components: {
    firstTable,
    matterTable
