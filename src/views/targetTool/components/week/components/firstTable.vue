  ...
  <div>
    <div>
      <el-table
        ...
        <el-table-column prop="fieldName" label="领域" width="350" align="center"></el-table-column>
        ...
        <!-- <el-table-column v-if="!disable" align="center" width="180">
          <template slot-scope="scope">
      ...
      this.$confirm('此操作将永久删除该条数据, 是否继续?', '提示', {
        ...
        baseRequest('/objective/rwMonthlyCont/delete', param)
          .then(response => {
            ...
            this.$emit('refresh', this.contType, row.fieldCode)
            this.searchOption()
          })
      })
    },
