  ...
  <div>
    <el-dialog
      ...
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules">
        <el-form-item style="margin-top:0px;" prop="actionName">
        ...
        <el-form-item style="margin-top:0px;" prop="principal">
        ...
        <el-form-item prop="endData">
            ...
            <el-date-picker style="width:100%" v-model="ruleForm.predictReachDate"
                type="date"
                value-format='yyyy-MM-dd'
