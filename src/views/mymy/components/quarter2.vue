...
></mark>
<el-input placeholder="请选择季度结束" v-model="showValue" style="width:221px;" @focus="showSeason=true">
  <i slot="prefix" class="el-input__icon el-icon-date"></i>
</el-input>
<el-card
  class="box-card"
  style="width:322px;padding: 0 3px 20px;margin-top:14px;position:fixed;z-index:9999 !important"
  v-show="showSeason"
>
