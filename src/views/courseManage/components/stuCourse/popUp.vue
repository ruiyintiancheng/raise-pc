    ...
    <div class="box-topmiddle">
        <el-form  :inline="true"  ref="form" :model="form" label-width="80px" class="sysquery">
            <el-row style="font-size:18px">
                <el-col :span="6">
                    <el-form-item label="教练名字" class="formitem" prop="userName">
                            <el-input placeholder="" clearable v-model="form.userName"></el-input>
                        </el-form-item>
                </el-col>
                <el-col :span="14">
                    <el-form-item label="开班日期">
                    <el-form-item label="" class="formitem" prop="startTime">
                        ...
                        <el-form-item label=""  prop="startTimeOne">
    ...
    <el-table class="table-main" :data="tableData" v-loading="loading"  @current-change="handleCurrentRowChange" border style="height:315px;overflow:auto">
        <el-table-column width="55" align="center">
           <template slot-scope="scope">
                <el-radio :disabled="scope.row.sNum > 4 ?true:false" v-model="radio" :label="scope.row.courseId"><span></span></el-radio>
                </template>
        </el-table-column>
      ...
      <el-table-column prop="loginName" label="教练手机号" align="center"></el-table-column>
       <el-table-column prop="email" label="教练邮箱" :show-overflow-tooltip="true" align="center"></el-table-column>
      <el-table-column prop="startTime" label="开班日期"  align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    tabledetail() {
      const param = {
        studentId: this.oldUserId.userId,
        ycourseId: this.oldUserId.courseId,
        xcourseId: this.rowItem.courseId,
        orderId: this.oldUserId.orderId
      }
      baseRequest('/course/firstStep/studentCourse', param).then((response) => {
    ...
    searchOption(page) {
      ...
      const params = {
        ...
        courseId: page.courseId || this.oldUserId.courseId
      }
      const data = Object.assign(this.form, params)
      baseSearch('/course/courses/courseStudentList', data).then((response) => {
