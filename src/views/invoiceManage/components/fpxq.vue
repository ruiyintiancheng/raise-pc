<template>
 ...
 <div class="box-middle">
  <el-form  :model="item"  >
    ...
    <el-radio-group v-model="item.invoiceStyle">
     ...
     <el-form-item label="公司名称：" class="fontColor"
 ...
 v-if="this.item.invoiceStyle==='1'&this.item.invoiceType==='0'? this.item.invoiceStyle==='1'&this.item.invoiceType==='0': this.item.invoiceStyle==='1'&this.item.invoiceType==='1'" 
      prop="taxNum" class="einstyle fontColor" style="margin-bottom:24px;margin-left:76px">
       <el-input v-model="item.taxNum" :disabled="true" style="width:330px;margin-left: 17px;"></el-input>
     </el-form-item>
      <el-form-item label="开户银行：" class="fontColor"
 v-if="this.item.invoiceStyle==='1'&this.item.invoiceType==='0'? this.item.invoiceStyle==='1'&this.item.invoiceType==='0': this.item.invoiceStyle==='1'&this.item.invoiceType==='1'"
     ...
     <el-form-item label="电子邮箱：" prop="email" class="fontColor"
...
v-if="this.item.invoiceStyle==='0'&this.item.invoiceType==='1'? this.item.invoiceStyle==='0'&this.item.invoiceType==='1':this.item.invoiceStyle==='1'&this.item.invoiceType==='1'" 
      class="numberstyle fontColor" prop="phone" style="margin-bottom:24px;margin-left:-2px">
       <el-input v-model="item.phone" :disabled="true"  style="width:330px;margin-left: 15px;"></el-input>
     </el-form-item>
     <el-form-item label="邮寄地址："
      class="addressstyle fontColor"
     v-if="this.item.invoiceStyle==='0'&this.item.invoiceType==='1'? this.item.invoiceStyle==='0'&this.item.invoiceType==='1':this.item.invoiceStyle==='1'&this.item.invoiceType==='1'" 
  ...
  <el-form-item label="开票日期："
      class="invoicedatestyle fontColor"
       prop="invoiceDate" style="margin-bottom:24px;margin-left:32px">
        <el-date-picker
        :disabled="this.item.invoiceDate? true:false" 
     ...
     <el-form-item label="发票号："
      class="Invoicenostyle fontColor"
       prop="invoiceNo" style="margin-bottom:24px;margin-left:48px">
       <el-input v-model="form.invoiceNo" :disabled="this.item.invoiceNo? true:false"   style="width:330px;margin-left: 16px;"></el-input>
     </el-form-item>
     </el-form> 
  <div class="box-button" v-if="!alreadyKp">
    <el-button type="primary" size="medium" class="sqbutton" v-if="!this.item.invoiceNo" @click="submitForm('refForm')">提交</el-button>
  </div>
 </div>
</el-dialog>
